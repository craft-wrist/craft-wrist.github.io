      ...
      <main id="main">
        ...
        <section className="section-shell design-section" id="design">
          ...
          <div className="design-layout">
            <figure className="design-figure workspace-figure"><PictureImage src="/media/craft-w-wrist-workspace.png" width={1215} height={1868} alt="CRAFT-W wrist workspace showing the bending and axial-rotation ranges" loading="lazy" decoding="async" /><figcaption><span>Fig. 02 / wrist workspace</span><span>±19.78° bending · +80° / −20° axial</span></figcaption></figure>
